...
CAPTION = "🎵 دانلود شده توسط @downloader_hamech"
user_urls = {}
user_search_results = {}
user_artist_data = {}
...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "instagram.com" in text:
        ...
        try:
            ...
            file_path = f"pinterest_{user_id}.{ext}"
            # اگر mp4 نشد، هر فایلی که هست بفرست
            ...
            keyboard = [[InlineKeyboardButton("کانال ما 📢", url="https://t.me/downloader_hamech")]]
