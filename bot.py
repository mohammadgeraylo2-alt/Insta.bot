...
def shazam_detect_from_file(input_path, rapidapi_key):
    ...
    # offset ها رو بر اساس مدت ویدیو تنظیم کن
    if duration > 0 and duration <= 20:
        # ویدیو کوتاه: از اول شروع کن
        time_offsets = [("0", str(int(min(duration, 15)))), ("0", str(int(min(duration, 10))))]
    else:
        # ویدیو بلندتر: چند جا امتحان کن
        time_offsets = [("0", "15"), ("5", "15"), ("20", "15"), ("0", "20")]
