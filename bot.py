...
async def yt_quality_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_audio:
        ...
        try:
            ...
            r = requests.get(
                "https://youtube-to-mp4-mp3.p.rapidapi.com/mp4",
                headers=yt4_headers,
            ...
            if isinstance(data_r, list) and data_r:
                ...
                download_url = data_r.get("url") or data_r.get("download_url") or data_r.get("link") or data_r.get("mp4") or data_r.get("videoUrl")
            last_err = data_r
        except Exception as e:
            last_err = str(e)
        if not download_url:
